...
class RomanceRemoteMediator (
    ...
    override suspend fun load(
        ...
        return try {
            ...
            val books:List<RomanceBook> = if (clearList.isNotEmpty()){
                clearList.map  {
    ...
    companion object PreferencesHelper {
        ...
        private const val PREFS_NAME = "romance_book_prefs"
        private const val KEY_CURRENT_POSITION = "romance_current_position"
